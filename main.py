...
# This service will use a manually refreshed Developer Token. This is the most reliable method for this account type.
BOX_ACCESS_TOKEN = os.environ.get('BOX_ACCESS_TOKEN')
OCR_API_KEY = os.environ.get('OCR_API_KEY')
BOX_API_BASE_URL = "https://api.box.com/2.0"
MAX_FILE_SIZE_BYTES = 1024 * 1024

# --- NEW: Endpoint for Listing Folder Contents ---
...
# --- The Existing Endpoint for Processing a File ---
